...
CREATE TABLE `admin` (
  ...
  `created_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间（注册时间）',
...
-- Records of comments
-- ----------------------------
INSERT INTO `comments` VALUES ('1', '1', '谢谢群主分享', '4', '2', '0', '0', '2019-09-04 15:11:06');
...
INSERT INTO `images` VALUES ('3', null, '2', '6', null, 'http://xxxx.avatar.jpg', '0', '2019-09-04 14:07:36');
...
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8 COMMENT='权限表';
...
-- Records of theme
-- ----------------------------
INSERT INTO `theme` VALUES ('1', '1', '关于陈田拆迁', '早就该拆了，交通天堵了，人又多，脏乱差', '0', '0', '0', '0', '0', '125487945314', 'wxid_12ddsassfsd45dd53447dd', '155695541', '0', '2019-09-06 16:59:14', null);
INSERT INTO `theme` VALUES ('2', '2', '男篮是世界杯', '中国男篮2胜3负无缘2020年东京夏季奥运会', '0', '0', '0', '0', '0', '18456885211', 'sxssx', '457451411', '0', '2019-09-09 15:36:41', null);
...
INSERT INTO `user` VALUES ('6', '南郭先生', '123456', 'http://img/avatar.default.png', '148869@qq.coom', '18856954464', null, null, '0', '132456', null, '\0', '\0', '0', '0', '0', '2019-09-09 15:38:41');
INSERT INTO `user` VALUES ('8', '诸葛', '132456', 'htt//img.avatar.default', '18457799@qq.com', '14887955', null, null, '0', '4566445', null, '\0', '\0', '0', '0', '0', '2019-09-09 15:39:42');
...
-- ----------------------------
INSERT INTO `user_collection` VALUES ('1', '4', '1', null, '0', '2019-09-06 15:09:48', null);
INSERT INTO `user_collection` VALUES ('2', '4', null, '1', '0', '2019-09-06 16:42:21', null);
